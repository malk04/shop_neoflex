    ...
    return <>
        <header>
            <div style={{display: "flex", justifyContent: "space-between"}}>
                ...
                <div className="menu" style={{display: "flex", marginTop: 5}}>
                    <Link to="https://ru.wikipedia.org/wiki/%D0%98%D0%B7%D0%B1%D1%80%D0%B0%D0%BD%D0%BD%D0%BE%D0%B5"
                          target="_blank">
                        <button className="icon" style={{marginRight: 30}}>
                            <svg className="icon-hover" width="23" height="20" viewBox="0 0 23 20" fill="none"
                            ...
                            <div className="icon-count" id="cart_num">2</div>
                        </button>
                    </Link>
                    <Link to={"/cart"}>
                        <button className="icon">
                            <svg className="cart-icon icon-hover" width="24" height="25" viewBox="0 0 24 25" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div className="icon-count" id="cart_num">{count}</div>
                        </button>
                    </Link>
                </div>
            </div>
